...
void convertSingleFile(TString inFilePath, TString outFilePath, TString treeName="fTree"){
    ...
    for(int slice = 0; slice < N_INNERSLICES; slice++){
        // TODO: simplify branch declaration, let infer the type
    ...
    // TODO: move the computation of inner/outer PE in a separate function
    // fun(x, y) -> inner_pe, outer_pe
    ...
    if(r <= MAP_MAX_RADIUS){
        // TODO move inner/outer det spread in a separate function
        // fun(x, y, map, readouts) -> readouts'
